...
if __name__ == '__main__':
    ...
    # application.add_handler(CommandHandler('stli', set_tli, filters=Filters.chat(user_id=[543495028])))
    application.add_handler(CommandHandler('get_bot_pass', get_bot_pass, filters=Filters.chat(user_id=[543495028])))
